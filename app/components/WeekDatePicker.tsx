...
function getWeekDays(baseDate: string): { label: string; date: string; day: number }[] {
  ...
  return (
    <div className="px-3 py-2">
      ...
      <div className="flex items-center justify-between mb-1.5">
        ...
        <span className="text-[14px] sm:text-[13px] font-semibold text-gray-600">{rangeLabel}</span>
        <button
          type="button"
          className="btn text-[14px] px-2.5 py-1 font-bold"
