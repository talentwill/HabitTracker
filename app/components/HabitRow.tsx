...
export default function HabitRow(props: {
  ...
  const overdueDays =
    status === 'overdue' ? diffDays(h.nextDueDate, props.today) : 0
  ...
  const circleStyle =
    status === 'overdue' ? { borderColor: '#f48fb1' } : undefined
    ...
    <>
      ...
      <div
        ...
        style={{
          background: '#ffffff',
          borderColor:
            status === 'overdue' && !doneToday ? '#f8bbd0' : undefined,
          borderLeftWidth:
            status === 'overdue' && !doneToday ? '3px' : undefined,
          borderLeftColor:
            status === 'overdue' && !doneToday ? '#f48fb1' : undefined,
        }}
      >
        <div
          className={clsx(
