...
export default function HabitPage() {
  ...
  const [confirmDeleteEvent, setConfirmDeleteEvent] =
    useState<HabitEvent | null>(null)
  const [confirmManualDone, setConfirmManualDone] = useState<string | null>(
    null
  )
  ...
  return (
    <div className="min-h-full pb-16 sm:pb-0">
          ...
          <div className="grid gap-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <div className="rounded-lg bg-warm-white px-3 py-3">
                <div className="text-[11px] font-semibold text-muted-light">
                  打卡次数
                </div>
              ...
              <div className="rounded-lg bg-warm-white px-3 py-3">
                ...
                <div className="mt-0.5 text-[22px] font-bold tracking-[-0.25px] text-ink">
                  {stats.avgGap ?? '—'}
                  {stats.avgGap ? (
                    <span className="text-[11px] text-muted-light ml-0.5">
                      天
                    </span>
                  ) : null}
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDraft({ ...draft, intervalDays: Number(e.target.value) })
                  }
                />
              </div>
              <div>
      ...
      >
        <div className="py-2 text-[14px] text-gray-600">
          确定要补打卡{' '}
          <span className="font-bold text-ink">{confirmManualDone}</span> 吗？
        </div>
      </Modal>
